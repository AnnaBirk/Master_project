...
def main_En_gG12A(ppar):
	...
	#############################
	# THIS COMMENTED OUT PART PLOTS CHARGE AND EIGENENERGY ON TOP OF THE CONDUCTANCE MAP, BUT THIS REPRESENTATION IS OUT-DATED.
	...
	ppar.mu_cut_index = 667 	# IMHERE move this definition to set_params file
...
ppar = SimpleNamespace(
    ...
    #
    # add something here if you want to add to the filename generated by misc.set_filename_skeleton(par,ppar)
    filename="",
...
# generate_En to be sent into main() such that not running diagonalization over again when not necessary.
main_En_gG12A(ppar)
